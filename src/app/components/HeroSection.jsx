       ...
       <>
           <div className="heroSection bg-gray-50 pt-28 pb-36 flex px-24 justify-between items-center">
              ...
              <div className="heroDetail flex flex-col gap-9">
                 <h1 className="heroHeading flex items-center font-bold">Welcome to QuickHealth <span className="heroHeartImage w-[5vw]"><Image className="mix-blend-multiply" src={heroImage} alt="hero Image"/></span></h1>
                 ...
                 <div className="heroBtnDiv flex gap-5">
                    ...
                    <button className="heroBtn border border-green-600 bg-gray-50 text-green-700 hover:bg-green-50 px-5 py-2.5 font-bold rounded-lg">Apply as Doctor</button>
                 </div>
              </div>
